...
const projects: Project[] = [
  {
    id: 1,
    title: "Coinguard - A personalised finance tracker",
    category: "Full Stack",
    client: "",
  ...
  {
    id: 2,
    title: "GoldTrends - AI-Powered Gold Price Tracker",
    category: "AI & ML",
    client: "",
...
export default function HorizontalScroll() {
  ...
  const renderDescriptionWithLinks = (description: string) => {
    ...
    const urls: string[] = description.match(urlRegex) || [];
  ...
  return (
    ...
    >
      ...
      <div className="px-6 md:px-12 mb-10 relative z-10 text-center">
        ...
        >
         Projects I've worked on, with details and tech stack used
        </motion.p>
