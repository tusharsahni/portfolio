...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://formsubmit.co/ajax/tusharsahni1234@gmail.com', {
        method: 'POST',
        headers: {
      ...
      try {
        if (formRef.current) {
          ...
          fallbackForm.action = 'https://formsubmit.co/tusharsahni1234@gmail.com';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          >
            ...
            <p className="text-gray-400 max-w-md mb-8">
              Have a project in mind? Let's collaborate to craft thoughtful, modern digital experiences.
            </p>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              {submitStatus === 'error' && (
                <div className="py-2 px-4 bg-red-900/20 border border-red-500/30 rounded-lg text-red-300">
                  There was an error sending your message. Please try again or <a href="mailto:tusharsahni1234@gmail.com?subject=Contact%20from%20Website" className="underline hover:text-red-200">contact me directly via email</a>.
                </div>
              )}
